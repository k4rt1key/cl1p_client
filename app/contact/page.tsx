...
export default function ContactPage() {
  return (
    <main className="max-w-3xl mx-auto py-12 px-4 space-y-6 mb-32">
      ...
      <p className="text-base md:text-lg">Have questions, feedback, or need support? Reach out to me directly:</p>
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 mt-4 space-y-6">
        <div className="flex flex-col md:flex-row gap-4 justify-center pt-2">
          ...
          <div className="flex items-center gap-3 px-6 py-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow hover:shadow-md transition-shadow duration-200 min-w-[220px] justify-center">
            ...
            <span className="font-medium text-base md:text-lg text-gray-800 dark:text-gray-200 select-all">kartikvaghasiya4477@gmail.com</span>
          </div>
          {/* LinkedIn Card */}
          <a
          ...
          >
            ...
            <span className="font-medium text-base md:text-lg text-gray-800 dark:text-gray-200">kartikey-vaghasiya</span>
          </a>
          {/* GitHub Card */}
          <a
          ...
          >
            ...
            <span className="font-medium text-base md:text-lg text-gray-800 dark:text-gray-200">k4rt1key</span>
          </a>
        </div>
      </div>
    </main>
